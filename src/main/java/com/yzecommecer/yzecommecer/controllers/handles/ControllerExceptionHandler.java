package com.yzecommecer.yzecommecer.controllers.handles;
...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<CustomError> resourceNotFond(ResourceNotFoundException e, HttpServletRequest request) {
	...
	public ResponseEntity<CustomError> methodArgumentNotValidadtion(MethodArgumentNotValidException e, HttpServletRequest request){
